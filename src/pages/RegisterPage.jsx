    ...
    <div className="flex items-center justify-center min-h-screen px-4 bg-pitch">
      <div className="w-full max-w-md p-8 bg-turf rounded-xl shadow-2xl border border-turf-light animate-rise-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-chalk-dim mb-1">Username</label>
            <input
              type="text"
              required
              value={username}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 font-display font-bold text-pitch bg-amber rounded-lg hover:bg-amber-dim transition-colors disabled:opacity-50 cursor-pointer"
          >
